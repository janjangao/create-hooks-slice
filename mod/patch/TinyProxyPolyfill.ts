...
function isPlainObject(value: any): boolean {
  ...
  const constructor = Object.hasOwnProperty.call(proto, "constructor") && proto.constructor;
  if (constructor === Object) return true;
  return typeof constructor == "function" && Function.toString.call(constructor) === objectCtorString;
}

export default function TinyProxyPolyfill(this: any, target: any, handler: Record<string, Function>) {
  ...
  const getter = handler.get ? function (this: any, prop: string) {
    return handler.get(this, prop, proxy);
  } : function (this: any, prop: string) {
    return this[prop];
  };
  const setter = handler.set ? function (this: any, prop: string, value: any) {
